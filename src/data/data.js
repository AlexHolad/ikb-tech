export const data = {
    ...
    sectionMain: {
        img: '/assets/images/thisisengineering-raeng-3Z3gnA99PL8-unsplash.jpg',
        attr: 'thisisengineering-raeng-3Z3gnA99PL8-unsplash',
        headline1: 'Maschinenbau',
        headline2: 'Auf dem höhsten Niveau',
        suppLine: 'Sowie Anlagenbau, Flugzeugbau und Vorrichtungsbau'
    },
    sectionLeistungen: {
        quote: '“IKB-TECH ist eine innovative Ingenieurdienstleistungsgesellschaft und ein zuverlässiger Partner im High-Tech-Umfeld mit Kundschaft aus verschiedenen Branchen der Großindustrie und dem Mittelstand.”',
        category: 'Leistungen',
    ...
    sectionKunden: {
        quote: '“Kundenzufriedenheit steht auf dem Ersten Platz in unserer Unternehmensphilosophie und bildet die Basis für eine langfristige und erfolgreiche Zusammenarbeit mit unseren Kunden.”',
        category: 'Referenzen',
    ...
    sectionSchwerpunkte: {
        ...
        schwerpunkte: [{
            ...
            services: ('Allgemeiner', 'Maschinenbau', 'Sondermaschinen', 'Betriebsmittelbau')
        }, {
            ...
            services: ('Automobilbau', 'Sonderfahrzeugbau', 'Schienentechnik', 'Nutzfahrzeugtechnik')
        }, {
    ...
    sectionProgrammen: {
        quote: '“Die mehrjährigen Erfahrungen unsere Mitarbeiter im Bereich Ingenieurwesen mit modernen CAD-Programmen und leistungsfähige Software-Tools bilden die Grundlage für unsere innovativen Entwicklungs- und Konstruktionsprozesse.”',
        category: 'Programmen',
        headline: 'Wir arbeiten mit moderner CAD-Software',
        text: ('Pro/Engineer Wildfiere 2/3/4', 'CATIA V4/V5', 'SolidWorks', 'Solid Edge', 'AutoCAD'),
        programmsLogos: [{
            logo: '/assets/logos/soft/catia.svg',
            attr: 'catia-logo'
        }, {
            logo: '/assets/logos/soft/ptc-creo.svg',
            attr: 'ptc-creo-logo'
        }, {
            logo: '/assets/logos/soft/solidworks.png',
            attr: 'solidworks'
        }, {
            logo: '/assets/logos/soft/solid-edge.png',
            attr: 'solid-edge'
        }, {
            logo: '/assets/logos/soft/autocad.svg',
            attr: 'autocad-logo'
        }]
    },
    sectionKontakt: {
        ...
        category: 'Kontakt',
        headline: 'Wir würden uns freuen Sie von den Vorteilen der IKB TECH zu überzeugen und freuen uns von Ihnen zu hören',
        contactTypes: [{
            icon: '',
            attr: '',
            text: ''
    ...
    sectionKarriere: {
        quote: '“Unseren Mitarbeitern bieten wir eine Unternehmenskultur die nicht einengt. Bei uns finden Sie Raum zur Entfaltung von unterschiedlichen Charakteren.”',
        category: 'Karriere',
    },
    footer: {
